#include "../include/multi_quadcopter_control/trajectory_generator.h"
...
TrajectoryGenerator::TrajectoryGenerator(ros::NodeHandle& nh) 
    ...
    m_trajectory_client = nh.serviceClient<multi_quadcopter_control::WaypointService>("get_trajectory");
