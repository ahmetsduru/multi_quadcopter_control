...
#include <multi_quadcopter_control/WaypointService.h>  // Include the service header
...
public:
    ...
    bool getTrajectoryCallback(multi_quadcopter_control::WaypointService::Request &req,
